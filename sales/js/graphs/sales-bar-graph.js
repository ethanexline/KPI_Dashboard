function sales_bar_graph_callback(returnString, divID, graph_title, graphWatch)
{
    xValue = [];
    yValue = [];
    xValue = [];
    
    sales_bar_graph_rpm_callback(returnString, "rate-per-mile", "<b>RPM by Origin to Destination <br> State (Top 25 Revenue)</b>", graphWatch);
