function callback(returnString)
        ...
        plot_bgcolor:"black",
        paper_bgcolor:"black",
        title: '<b>Fleetmaster Regional/OTR Revenue for the Week</b><br>' + formatter.format(currentAmt),
            xaxis: {
                type:'category'
            },
...
httpGetAsync("../KPIGraphs/dash_home/api/v1/daily_revenue/102", callback);