class sorting{
    ...
    */
    ...
    getGlobalSortString(sortOptions = false){
        ...
        if(sortOptions != null){
            ...
            if(sortOptions.status != "") {
                newSort.status = sortOptions.status;
            }
    ...
    loadSortFromStorage(){
        ...
        if(sortOptions == null){
            local_storage.SetLocalStorage("sort-options", {"divisions":["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102","301"],"startDate":"","endDate":""});
        }
    
        this.getSortOptions("/kpigraphs/units/api/divisions", this.addSortDivisions, 'sort-divisions');
        this.getSortOptions("/kpigraphs/units/api/terminals", this.addSortTerminals, 'sort-terminals');
  ...
  //Stores the global sort parameters in the browser's local storage 
    GlobalSort(){
        ...
        util.toastLaunch("tradeToast", "#007bff", "Custom sort has been applied.");
        util.toastLaunch("lookupToast", "#007bff", "Custom sort has been applied.");
    ...
    //Stores the global sort parameters in the browser's local storage 
    GlobalSortDefault() {
        local_storage.SetLocalStorage("sort-options", {"divisions":["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102","301"],"startDate":"","endDate":"","status":"all"});
    ...
    GlobalSortDefaultBtn() {
        ...
        util.toastLaunch("tradeToast", "#ffc107", "Default sort has been applied.");
        util.toastLaunch("lookupToast", "#ffc107", "Default sort has been applied.");
    ...
    PresetSort(presetID){
        ...
        if (presetID == "default") 
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102","301"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
        ...
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
            local_storage.SetLocalStorage("slice-btn", presetID);
            unPressTrade();
        }
        ...
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["100","110"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
            local_storage.SetLocalStorage("slice-btn", presetID);
            unPressTrade();
        }
        ...
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["300","303","310","311","312","314","315","320","400","402","405","415"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
            local_storage.SetLocalStorage("slice-btn", presetID);
            unPressTrade();
        }
        ...
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["900"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["102"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
            local_storage.SetLocalStorage("slice-btn", presetID);
            unPressTrade();
        }
        ...
        {
            local_storage.SetLocalStorage("sort-options", {"divisions":["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"],"terminals":["TSM","ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS"],"companies":["301"],"startDate": sortOptions.startDate,"endDate": sortOptions.endDate,"status":"all"});
            local_storage.SetLocalStorage("slice-btn", presetID);
            unPressTrade();
        }
        ...
        else if(presetID == "BTH")
        {
            sortOptions.divisions = ["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","600","610","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"];
            sortOptions.terminals = ["ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","ENM","FIN","FTW","HAR","LAT","LMC","MON","MTC","NCO","RKE","SPR","WEI","WMS","TSM"];
            sortOptions.companies = ["102","301"];
            local_storage.SetLocalStorage("sort-options", sortOptions);
            local_storage.SetLocalStorage("comp-buttons", presetID);
            unPressDash();
        }

        else if(presetID == "FLT")
        {
            sortOptions.divisions = ["100","110","111","201","202","300","303","310","311","312","314","315","320","400","402","405","415","500","700","701","703","710","716","800","801","803","805","811","900","901","902","909","910","930","990","COR","TRM"];
            sortOptions.terminals = ["ALB","BUM","CHT","COL","COR","DAN","DEF","EDE","FIN","FTW","HAR","LAT","LMC","MON","NCO","RKE","SPR","WEI","WMS","TSM","ENM"];
            sortOptions.companies = ["102","301"];
            local_storage.SetLocalStorage("sort-options", sortOptions);
            local_storage.SetLocalStorage("comp-buttons", presetID);
            unPressDash();
        ...
        else if(presetID == "ENG")
        {
            sortOptions.divisions = ["600","610"];
            sortOptions.terminals = ["ENM","MTC","TSM"];
            sortOptions.companies = ["301"];
            local_storage.SetLocalStorage("sort-options", sortOptions);
            local_storage.SetLocalStorage("comp-buttons", presetID);
            unPressDash();
        }

        else if(presetID == "stat-all")
        {
            sortOptions.status = "all";
            local_storage.SetLocalStorage("sort-options", sortOptions);
            local_storage.SetLocalStorage("stat-buttons", presetID);
            unPressDash();
        }

        else if(presetID == "green")
        {
        ...
        else if(presetID == "yellow")
        {
            sortOptions.status = "2";
            local_storage.SetLocalStorage("sort-options", sortOptions);
            local_storage.SetLocalStorage("stat-buttons", presetID);
            unPressDash();
        }
