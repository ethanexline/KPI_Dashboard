function units_pie_graph_callback(returnString, divID, graph_title)
{
    xValue = [];
    yValue = [];
    
    if (graph_title == "<b>Top 10 Repair Costs</b>") {
        returnString.slice(0,9).forEach(element => xValue.push(util.capitalize_Words(element.description)));
