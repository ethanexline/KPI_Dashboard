class sorting{
    ...
    */
    ...
    loadSortFromStorage(){
        ...
        this.getSortOptions("/kpigraphs/orders/api/divisions", this.addSortDivisions, 'sort-divisions');
        this.getSortOptions("/kpigraphs/orders/api/terminals", this.addSortTerminals, 'sort-terminals');
