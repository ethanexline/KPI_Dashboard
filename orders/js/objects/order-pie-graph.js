function order_pie_graph_callback(returnString, divID, graph_title)
{
    xValue = [];
    yValue = [];
    
    returnString.slice(0,9).forEach(element => xValue.push(util.capitalize_Words(element.commodity)));
